...
export default function GlobalError({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.className} min-h-screen bg-[#0B0F19] antialiased flex flex-col items-center justify-center p-8`}>
        <div className="flex flex-col items-center justify-center p-10 bg-slate-900/50 backdrop-blur-xl rounded-3xl border border-red-500/20 shadow-2xl shadow-red-500/10 max-w-lg w-full transition-all duration-500 ease-out animate-in fade-in slide-in-from-bottom-4">
          ...
          <p className="text-slate-400 mb-8 leading-relaxed max-w-sm text-center">
            A fatal error occurred that brought down the application layout. Our engineering team has been alerted.
          </p>
