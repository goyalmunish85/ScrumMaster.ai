    ...
    <div className="flex h-screen overflow-hidden bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-8 no-scrollbar">
          ...
          <div className="px-2 mt-8">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 rounded-xl bg-slate-800/40 border border-slate-700/50 hover:bg-slate-700/40 px-3 py-2.5 text-sm font-medium text-slate-300 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-indigo-400"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
              Global Timeline
            </button>
          </div>
        </div>
      ...
      {showTimelineModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-[#0B0F19] border border-slate-800 w-full max-w-4xl h-[80vh] rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-900/50">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl bg-indigo-500/20 flex items-center justify-center border border-indigo-500/30">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-indigo-400"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                </div>
              ...
              <button
                ...
                aria-label="Close Global Timeline"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
