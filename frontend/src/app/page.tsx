        ...
        <div className="flex-1 overflow-y-auto px-4 py-6 space-y-8 no-scrollbar">
          <div>
            ...
            <div className="space-y-1 mt-4">
              <a href="/dashboard" className="w-full flex items-center gap-3 rounded-xl hover:bg-slate-800/50 px-3 py-2.5 text-sm font-medium text-slate-400 transition-all hover:text-slate-200">
